(function (global, factory) {
    ...
    var SetupSyncFlags = function (state, config) {
        ...
        if (typeof (config) === 'boolean') {
            ...
            state.syncCameraFilter = GetValue$16(config, 'syncCameraFilter', true);
            state.syncDisplayList = GetValue$16(config, 'syncDisplayList', true);
        }
    ...
    */
    ...
    var DrawBounds$2 = function (gameObjects, graphics, config) {
        ...
        if (typeof (config) === 'number') {
            ...
            fillAlpha = GetValue$14(config, 'fillAlpha');
            padding = GetValue$14(config, 'padding');
            includeParent = GetValue$14(config, 'includeParent');
        }
    ...
    class Anchor extends ComponentBase {
        ...
        resetFromJSON(o) {
            ...
            var onResizeCallback = GetValue$_(o, 'onResizeCallback', DefaultResizeCallback);
            var onResizeCallbackScope = GetValue$_(o, 'onResizeCallbackScope');
            this.setResizeCallback(onResizeCallback, onResizeCallbackScope);

            var onUpdateViewportCallback = GetValue$_(o, 'onUpdateViewportCallback');
            var onUpdateViewportCallbackScope = GetValue$_(o, 'onUpdateViewportCallbackScope');
    ...
    */
    ...
    class Base extends ContainerLite {
        constructor(scene, x, y, minWidth, minHeight, config) {
            ...
            var origin = GetValue$u(config, 'origin', 0.5);
            var originX = GetValue$u(config, 'originX', origin);
            var originY = GetValue$u(config, 'originY', origin);
            this.setOrigin(originX, originY);

            this.setMinSize(minWidth, minHeight);
            this.setName(GetValue$u(config, 'name', ''));
            this.rexSizer = {};
            this.space = {};
            ...
            this.setInnerPadding(GetValue$u(config, 'space', 0));
            ...
            this.setSizerEventsEnable(GetValue$u(config, 'sizerEvents', false));
            this.setDirty(true);
    ...
    class Sizer extends Base {
        constructor(scene, x, y, minWidth, minHeight, orientation, config) {
            ...
            this.setItemSpacing(GetValue$s(config, 'space.item', 0));
            this.setStartChildIndex(GetValue$s(config, 'startChildIndex', 0));
    ...
    var Add = function (gameObject, columnIndex, rowIndex, align, paddingConfig, expand, childKey) {
        ...
        if (IsPlainObject$7(columnIndex)) {
            ...
            columnIndex = GetValue$r(config, 'column', undefined);
            rowIndex = GetValue$r(config, 'row', undefined);
            align = GetValue$r(config, 'align', ALIGN_CENTER);
        ...
        if (IsPlainObject$7(expand)) {
            config.expandWidth = GetValue$r(expand, 'width', false);
            config.expandHeight = GetValue$r(expand, 'height', false);
        } else {
    ...
    var ResetGrid = function (
        ...
        // space
        this.setColumnSpace(GetValue$q(space, 'column', 0));
        this.setRowSpace(GetValue$q(space, 'row', 0));
    ...
    class GridSizer extends Base {
        constructor(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
            if (IsPlainObject$6(x)) {
                ...
                columnCount = GetValue$p(config, 'column', (config.col || 0));
                rowCount = GetValue$p(config, 'row', 0);
                columnProportions = GetValue$p(config, 'columnProportions', 0);
                rowProportions = GetValue$p(config, 'rowProportions', 0);
            ...
            this.sizerChildren = [];
            this.addChildrenMap('items', this.sizerChildren);
            this.setCreateCellContainerCallback(GetValue$p(config, 'createCellContainerCallback'));

            this.setIndentLeft(
                GetValue$p(config, 'space.indentLeftOdd', 0),
                GetValue$p(config, 'space.indentLeftEven', 0)
            );
            this.setIndentTop(
                GetValue$p(config, 'space.indentTopOdd', 0),
                GetValue$p(config, 'space.indentTopEven', 0)
            );

            this.resetGrid(
                columnCount, rowCount,
                columnProportions, rowProportions,
                GetValue$p(config, 'space', undefined)
            );
            ...
            childParent.add(child,
                {
                    ...
                    expand: {
                        width: GetValue$o(childConfig, 'expandWidth', true),  // Private
    ...
    */
    ...
    var BuildAutoDashPattern = function (dashPattern, totalPathLength) {
        var segmentCount = GetValue$n(dashPattern, 'segments', DEFAULT_SEGMENT_COUNT);
        var drawRatio = GetValue$n(dashPattern, 'drawRatio', DEFAULT_DRAW_RATIO);
    ...
    var BuildDashStroke = function (pathData, config, out) {
        ...
        var closePath = GetValue$n(config, 'closePath', false);
        var totalPathLength = GetTotalPathLength(pathData, closePath);
        var dashPattern = NormalizeDashPattern(GetValue$n(config, 'dashPattern', undefined), totalPathLength);
        var dashOffset = GetValue$n(config, 'dashOffset', 0);
    ...
    class RoundRectangle extends PolygnBase {
        constructor(scene, x, y, width, height, radiusConfig, fillColor, fillAlpha) {
            ...
            this.setIteration(GetValue$l(radiusConfig, 'iteration', undefined));
            this.setPosition(x, y);
    ...
    class StyleManager extends ComponentBase {
        constructor(gameObject, config) {
            ...
            this.style = GetValue$k(config, 'style', this);

            var propertiesMap = GetValue$k(config, 'propertiesMap');
            ...
            this.onModifyStyle = GetValue$k(config, 'onModifyStyle');
        }
        ...
        class ProgressBase extends BaseClass {
            bootProgressBase(config) {
                ...
                this
                    ...
                    .setEaseValueDuration(GetValue$j(config, 'easeValue.duration', 0))
                    .setEaseValueFunction(GetValue$j(config, 'easeValue.ease', 'Linear'));
    ...
    class LineProgress extends ProgressBase(BaseShapes) {
        constructor(scene, x, y, width, height, barColor, value, config) {
            ...
            this.setTrackColor(GetValue$i(config, 'trackColor', undefined));
            this.setBarColor(barColor);
            this.setTrackStroke(GetValue$i(config, 'trackStrokeThickness', 2), GetValue$i(config, 'trackStrokeColor', undefined));

            this.setSkewX(GetValue$i(config, 'skewX', 0));
    ...
    class StatesNineSlice extends PhaserNineSlice {
        constructor(scene, config) {
            ...
            var key = GetValue$h(config, 'key', null);
            var frame = GetValue$h(config, 'frame', null);
            var width = GetValue$h(config, 'width', 0);
            var height = GetValue$h(config, 'height', 0);
            var leftWidth = GetValue$h(config, 'leftWidth', 0);
            var rightWidth = GetValue$h(config, 'rightWidth', 0);
            var topHeight = GetValue$h(config, 'topHeight', 0);
            var bottomHeight = GetValue$h(config, 'bottomHeight', 0);
    ...
    class StatesImage extends PhaserImage {
        constructor(scene, config) {
            ...
            var frame = GetValue$g(config, 'frame', undefined);
    ...
    var SetStretchMode = function(mode) {
        if (IsPlainObject$3(mode)) {
            this.stretchMode.edge = parseMode(GetValue$f(mode, 'edge', 0));
            this.stretchMode.internal = parseMode(GetValue$f(mode, 'internal', 0));
        } else {
            mode = parseMode(mode);
        ...
        class NinePatch extends GOClass {
            constructor(scene, x, y, width, height, key, baseFrame, columns, rows, config) {
                if (IsPlainObject$2(x)) {
                    ...
                    width = GetValue$e(config, 'width', 1);
                    height = GetValue$e(config, 'height', 1);
                    key = GetValue$e(config, 'key', undefined);
                    baseFrame = GetValue$e(config, 'baseFrame', undefined);
                    columns = GetValue$e(config, 'columns', undefined);
                    rows = GetValue$e(config, 'rows', undefined);
                ...
                if (baseFrame === undefined) {
                    baseFrame = GetValue$e(config, 'frame', undefined);
                }

                if (columns === undefined) {
                    var leftWidth = GetValue$e(config, 'leftWidth', undefined);
                    var rightWidth = GetValue$e(config, 'rightWidth', undefined);
                ...
                if (rows === undefined) {
                    var topHeight = GetValue$e(config, 'topHeight', undefined);
                    var bottomHeight = GetValue$e(config, 'bottomHeight', undefined);
                ...
                this.setGetFrameNameCallback(GetValue$e(config, 'getFrameNameCallback', undefined));
                this.setStretchMode(GetValue$e(config, 'stretchMode', 0));
                this.setPreserveRatio(GetValue$e(config, 'preserveRatio', true));

                var maxFixedPartScale = GetValue$e(config, 'maxFixedPartScale', 1);
                var maxFixedPartScaleX = GetValue$e(config, 'maxFixedPartScaleX', maxFixedPartScale);
                var maxFixedPartScaleY = GetValue$e(config, 'maxFixedPartScaleY', undefined);
    ...
    class StatesNinePatch extends NinePatch {
        constructor(scene, config) {
            ...
            var effectConfig = GetValue$d(config, 'effects', true);
            if (effectConfig) {
                AddEffectProperties(this, effectConfig);
            }
    ...
    class DragSpeed extends ComponentBase {
        constructor(gameObject, config) {
            ...
            this.rectBoundsInteractive = GetValue$9(config, 'rectBoundsInteractive', false);
        ...
        resetFromJSON(o) {
            ...
            this.holdThreshold = GetValue$9(o, 'holdThreshold', 50); // ms
            this.pointerOutReleaseEnable = GetValue$9(o, 'pointerOutRelease', true);
            return this;
        }
    ...
    class Movement {
        ...
        resetFromJSON(o) {
            this.setValue(GetValue$8(o, 'value', 0));
            this.setSpeed(GetValue$8(o, 'speed', 0));
            this.setAcceleration(GetValue$8(o, 'acceleration', 0));
            return this;
        }
    ...
    class Scroller extends ComponentBase {
        constructor(gameObject, config) {
            ...
            var drapSpeedConfig = {
                rectBoundsInteractive: GetValue$7(config, 'rectBoundsInteractive', false),
                inputConfig: GetValue$7(config, 'inputConfig', undefined),
                enable: enable,
                pointerOutRelease: GetValue$7(config, 'pointerOutRelease', true),
                eventEmitter: false,
            };
            ...
            this.setSnapStep(GetValue$7(config, 'snapStep', undefined));
            ...
            callback = GetValue$7(config, 'overmaxCallback', null);
            if (callback !== null) {
                var scope = GetValue$7(config, 'overmaxCallbackScope', undefined);
                this.on('overmax', callback, scope);
            }
            callback = GetValue$7(config, 'overminCallback', null);
            if (callback !== null) {
                var scope = GetValue$7(config, 'overminCallbackScope', undefined);
        ...
        resetFromJSON(o) {
            this.setOrientationMode(GetValue$7(o, 'orientation', 0));
            this.setDragThreshold(GetValue$7(o, 'threshold', 10));
            this.setSlidingDeceleration(GetValue$7(o, 'slidingDeceleration', 5000));
            this.setBackDeceleration(GetValue$7(o, 'backDeceleration', 2000));

            var dragRate = GetValue$7(o, 'dragRate', 1);
            dragRate = dragRate * (GetValue$7(o, 'dragReverse', false) ? -1 : 1);
            this.setDragRate(dragRate);

            var bounds = GetValue$7(o, 'bounds', undefined);
            if (bounds) {
                this.setBounds(bounds);
            } else {
                this.setBounds(GetValue$7(o, 'max', 0), GetValue$7(o, 'min', 0));
            }
            this.setValue(GetValue$7(o, 'value', this.maxValue || 0));
    ...
    class MouseWheelScroller extends ComponentBase {
        constructor(gameObject, config) {
            ...
            if (this.parent !== this.scene) {
                this.focusMode = GetValue$6(config, 'focus', true);
            } else {
            ...
            this.setSpeed(GetValue$6(config, 'speed', 0.1));
            ...
            switch (this.focusMode) {
                ...
                default:  // case 1
                    gameObject
                        .setInteractive(GetValue$6(config, "inputConfig", undefined))
    ...
    var AddSlider = function (topPatent, sliderParent, axis, config) {
        ...
        if (isScrollXYMode) {
            snapStep = GetValue$5(config, snapStepKey, undefined);
        } else {
            var snapStep = GetValue$5(config, 'snapStep', undefined);
        ...
        if (isScrollXYMode) {
            sliderConfig = GetValue$5(config, sliderConfigKey, undefined);
        } else {
            if (config.hasOwnProperty(sliderConfigKey)) {
                sliderConfig = GetValue$5(config, sliderConfigKey, undefined);
            } else {
                sliderConfig = GetValue$5(config, 'slider', undefined);
            }
        }
        ...
        if (sliderConfig) {
            ...
            var sliderPosition = GetValue$5(sliderConfig, 'position', 0);
            ...
            3. space.child
            */
            var sliderPadding = GetValue$5(config, `space.slider${axis}`, undefined);
            var childPadding;  // Legacy
            if (sliderPadding === undefined) {
                sliderPadding = GetValue$5(config, 'space.slider', undefined);
                if (sliderPadding === undefined) {
                    if (isScrollXYMode) {
                        sliderPadding = 0;
                    } else {
                        childPadding = GetValue$5(config, 'space.child', 0);
                    }
                }
            }
            ...
            topPatent[`hideUnscrollableSlider${axis}`] = GetValue$5(sliderConfig, 'hideUnscrollableSlider', false);
            topPatent[`disableUnscrollableDrag${axis}`] = GetValue$5(sliderConfig, 'disableUnscrollableDrag', false);
            topPatent[`adaptThumb${axis}SizeMode`] = GetValue$5(sliderConfig, 'adaptThumbSize', false);
            topPatent[`minThumb${axis}Size`] = GetValue$5(sliderConfig, 'minThumbSize', undefined);
        ...
        var scrollDetectionMode = GetValue$5(config, 'scrollDetectionMode');
        ...
        if (isScrollXYMode) {
            scrollerConfig = GetValue$5(config, scrollerConfigKey, true);
        } else {
            if (config.hasOwnProperty(scrollerConfigKey)) {
                scrollerConfig = GetValue$5(config, scrollerConfigKey, true);
            } else {
                scrollerConfig = GetValue$5(config, 'scroller', true);
            }
        }
        ...
        var mouseWheelScrollerConfig = GetValue$5(config, ((isScrollXYMode) ? `mouseWheelScroller${axis}` : 'mouseWheelScroller'), false),
            mouseWheelScroller;
    ...
    var CreateScrollableSizer = function (parent, config) {
        ...
        var parentMinWidth = GetValue$4(config, 'width');
        var parentMinHeight = GetValue$4(config, 'height');
        if (!parentMinWidth) {
            var expandChildWidth = GetValue$4(config, 'child.expandWidth', true);
            if (!expandChildWidth) {
                columnProportions[1] = 0;  // Calculate parent's width by child's width
            }
        }
        if (!parentMinHeight) {
            var expandChildHeight = GetValue$4(config, 'child.expandHeight', true);
    ...
    class Scrollable extends Sizer {
        constructor(scene, config) {
            ...
            super(scene, config);
            this.type = GetValue$3(config, 'type', 'rexScrollable');
                ...
                this.add(footer,
                    {
                        ...
                        align: align,
                        padding: padding,
                        expand: GetValue$3(config, 'expand.footer', true)
                    }
                );
            }
            ...
            if (header) {
                ...
                var headerAlign = GetValue$3(config, 'align.header', 'center');
                var headerExpand = GetValue$3(config, 'expand.header', true);
                this.addHeader(header, headerSpace, headerAlign, headerExpand);
            }

            var footer = GetValue$3(config, 'footer', undefined);
            if (footer) {
                var footerSpace = GetValue$3(config, 'space.footer', 0);
                var footerAlign = GetValue$3(config, 'align.footer', 'center');
                var footerExpand = GetValue$3(config, 'expand.footer', true);
    ...
    class ScrollableBlock extends Base {
        constructor(scene, x, y, minWidth, minHeight, config) {
            ...
            var clampChildOY = GetValue$1(config, 'clampChildOY', true);
            var clampChildOX = GetValue$1(config, 'clampChildOX', clampChildOY);
            ...
            var childOrigin0 = GetValue$1(config, 'childOrigin0', true);
