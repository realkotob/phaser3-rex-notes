(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexcustomprogress = factory());
    ...
    */
    ...
    var BuildAutoDashPattern = function (dashPattern, totalPathLength) {
        var segmentCount = GetValue$b(dashPattern, 'segments', DEFAULT_SEGMENT_COUNT);
        var drawRatio = GetValue$b(dashPattern, 'drawRatio', DEFAULT_DRAW_RATIO);
    ...
    var BuildDashStroke = function (pathData, config, out) {
        ...
        var closePath = GetValue$b(config, 'closePath', false);
        var totalPathLength = GetTotalPathLength(pathData, closePath);
        var dashPattern = NormalizeDashPattern(GetValue$b(config, 'dashPattern', undefined), totalPathLength);
        var dashOffset = GetValue$b(config, 'dashOffset', 0);
