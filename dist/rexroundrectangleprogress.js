(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexroundrectangleprogress = factory());
    ...
    function ProgressBase (BaseClass) {
        class ProgressBase extends BaseClass {
            bootProgressBase(config) {
                this.eventEmitter = GetValue$4(config, 'eventEmitter', this);
                ...
                this
                    ...
                    .setEaseValueDuration(GetValue$4(config, 'easeValue.duration', 0))
                    .setEaseValueFunction(GetValue$4(config, 'easeValue.ease', 'Linear'));
    ...
    */
    ...
    var BuildAutoDashPattern = function (dashPattern, totalPathLength) {
        var segmentCount = GetValue$2(dashPattern, 'segments', DEFAULT_SEGMENT_COUNT);
        var drawRatio = GetValue$2(dashPattern, 'drawRatio', DEFAULT_DRAW_RATIO);
    ...
    var BuildDashStroke = function (pathData, config, out) {
        ...
        var closePath = GetValue$2(config, 'closePath', false);
        var totalPathLength = GetTotalPathLength(pathData, closePath);
        var dashPattern = NormalizeDashPattern(GetValue$2(config, 'dashPattern', undefined), totalPathLength);
        var dashOffset = GetValue$2(config, 'dashOffset', 0);
