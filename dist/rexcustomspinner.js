(function (global, factory) {
    ...
    class Base extends BaseShapes {
        constructor(scene, config) {
            ...
            if (GetValue$5(config, 'start', true)) {
                this.start();
            }
        }
        ...
        resetFromConfig(config, setDefaults) {
            ...
            this.setDuration(GetValue$5(config, 'duration', defaultValue));

            defaultValue = (setDefaults) ? 'Linear' : this.ease;
            this.setEase(GetValue$5(config, 'ease', defaultValue));

            defaultValue = (setDefaults) ? 0 : this.delay;
            this.setDelay(GetValue$5(config, 'delay', defaultValue));

            defaultValue = (setDefaults) ? 0 : this.repeatDelay;
            this.setRepeatDelay(GetValue$5(config, 'repeatDelay', defaultValue));

            defaultValue = (setDefaults) ? 0xffffff : this.color;
            this.setColor(GetValue$5(config, 'color', defaultValue));

            defaultValue = (setDefaults) ? 0 : this.value;
            this.setValue(GetValue$5(config, 'value', defaultValue));
